...
looked up in `agent.stages.STAGE_FACTORIES` (extendable via
...
`agent/__init__.py` needs to change either way.
...
class PipelineConfig:
    ...
    # agent.stages.STAGE_FACTORIES at ProjectPipeline construction time.
